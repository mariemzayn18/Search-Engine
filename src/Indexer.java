...
public class Indexer {
    ...
    Indexer() {
        ...
        // now update priority =TF*IDF -->> IDF= no.of docs in DB/ no.of docs contain the word
...
//---------------- start calculating priority -------------------------
        ...
        //this is a new map for each document call the function but the hash table global for all the documents
      ...
      // normalized TF = no. of occurances of the word in the doc/no. of words in this doc
      Double TF;
  ...
  // if not a spam store the word in the hash table with its value ( Key :word , value: doc contains URL & priority)
      org.bson.Document Word_Value = new org.bson.Document("Word", myword).append("URL", URL).append("priority", TF);
