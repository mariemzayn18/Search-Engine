...
//        int i=0;
//        while (i<seeds.size()){
//           links.add(seeds.get(i)); // store the links in the hash set at the beginning before the crawling process
//            i++;
//        }
        ...
        //if (FirstCrawling) //uncomment this
        {
            for (int i = 0; i < Num; i++) {
                if (Integer.parseInt(Thread.currentThread().getName()) == i) {
                    /////////////////////////////// feh haga hena msh sa777 mafrod lama yrga3 myrg3sh mn l awal tanyy///////////////////////////
                    myUrl= seeds.get(i);
                    getPageLinks(this.myUrl);
                    //   System.out.println ("Thread "+ Thread.currentThread().getName() + " hellllo");
                }
                if (i==Num-1)
                    FirstCrawling=false;
            }
        }
//        else ///////////////////////////////// loop on the hash set/////////////////////////////////////////
//        {
//            for (int i = 0; i < Num; i++) {
//                if (Integer.parseInt(Thread.currentThread().getName()) == i) {
//                    myUrl= seeds.get(i); //////////////////////////////////I think this should be hashset/////////////////////////////////////////////////////
//                    getPageLinks(this.myUrl);
//                    System.out.println ("Thread "+ Thread.currentThread().getName() + " hellllo");
//                }
//            }
...
//// try catch
            ...
            for (Element page : linksOnPage) {
                ...
                // 1- lesa f awl mara crawling aw msh awl mara 3adyy & the first visit for the page
...
// revisit first those with which don't contain famous domain --> 3shan akhazen urls gdeda w ela hafdal daymn bazor l urls l famous only fa hadkhol fe infinite loop keda :(((
